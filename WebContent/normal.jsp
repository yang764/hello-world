...
<script type="text/javascript">
	  ...
	  window.onload = function(){
		...
		if(c == 4){			
			...
			window.location.href = "cong2.html";
		}	
		if(c == ""){
...
<body>
	...
	<span id="cc"></span>
	<span id="dd"></span>
	<image id="img" onclick="openDiv(this)" src="image/normal.PNG"></image>
	<div id="menu"> 				
	...
	<form method="get" action="/613/Normal"
		onkeydown="if(event.keyCode==13)return false;">
		<table>
			<tr>

				<td> 
					  <input id="button" type="submit" name="module" value="Table" /> 
					<span id="span1"></span>
				</td>
				<td />
				<td />
				...
				<td />
				<td> 
					 <input id="button" type="submit" name="module" value="CreateTable" /> 
					<span id="span1"></span>
				</td>
				<td />
				<td />
				...
				<td />
				<td> 
					  <input id="button" type="submit" name="module" value="Font" /> 
					<span id="span1"></span>
				</td>
